...
let chessmanCollection = wrapper.querySelectorAll('.chessman');
let chessmanCollectionLength = chessmanCollection.length;

//We add a handler to each figure because event delegation will not work 
//due to a change in the positioning of the figures to absolute
for(let i = 0; i < chessmanCollectionLength; i++ ) {
	chessmanCollection[i].addEventListener('mousedown', pickElement);
}
